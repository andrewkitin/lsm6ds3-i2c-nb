...
/**
  ...
  *         HSE_STARTUP_TIMEOUT in stm32f40x.h file. You can tailor it depending
...
/**
  ...
  * @note     (*) HSI_VALUE is a constant defined in stm32f40x.h file (default value
  *               16 MHz) but the real value may vary depending on the variations
  *               in voltage and temperature.
  * @note     (**) HSE_VALUE is a constant defined in stm32f40x.h file (default value
