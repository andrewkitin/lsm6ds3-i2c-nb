/**
  ...
  *                I2S_EXTERNAL_CLOCK_VAL in the stm32f40x_conf.h file. 
  *
  ...
  *          then the define I2S_EXTERNAL_CLOCK_VAL in file stm32f40x_conf.h should 
...
/**
  ...
  *         I2S_EXTERNAL_CLOCK_VAL in file stm32f40x_conf.h should be enabled and set
...
/*----------------------- SPIx I2SCFGR & I2SPR Configuration -----------------*/
  ...
  else
  {
    ...
    /* If an external I2S clock has to be used, this define should be set  
       in the project configuration or in the stm32f40x_conf.h file */
...
@note When the STM32F40x is configured as slave and the NSS hardware mode is 
